...
export default class BlockElement extends React.Component<BlockProps, BlockState> {
    constructor(props : BlockProps) {
        super(props);
        this.state = {block: this.props.block, col: this.props.col, row: this.props.row};
    }
    ...
    render(): React.ReactNode {
        return (
            <button onClick = {this.handleClick } style={{"color":this.props.block?.color}}>
